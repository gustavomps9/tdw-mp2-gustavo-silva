  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-between px-2 pointer-events-none">
        <span
          className={`text-xs font-bold transition-all duration-300 ${isPortuguese ? "text-gray-400" : "text-white"}`}
        >
          EN
        </span>
        <span
          className={`text-xs font-bold transition-all duration-300 ${isPortuguese ? "text-white" : "text-gray-400"}`}
        >
          PT
        </span>
      </div>
